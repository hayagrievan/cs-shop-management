...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.part_label = tk.Label(
            self.master, text='Part Name', font=('bold', 20), pady=20)
        ...
        self.customer_label = tk.Label(
            self.master, text='Customer', font=('bold', 20))
        ...
        self.retailer_label = tk.Label(
            self.master, text='Retailer', font=('bold', 20))
        ...
        self.price_label = tk.Label(
            self.master, text='Price', font=('bold', 20))
        ...
        # Parts list (listbox)
        self.parts_list = tk.Listbox(self.master, height=30, width=50, border=4)
        ...
        self.add_btn = tk.Button(
            self.master, text="Add Part", width=20, command=self.add_item)
        self.add_btn.grid(row=2, column=0, pady=20)

        self.remove_btn = tk.Button(
            self.master, text="Remove Part", width=20, command=self.remove_item)
        self.remove_btn.grid(row=2, column=1)

        self.update_btn = tk.Button(
            self.master, text="Update Part", width=20, command=self.update_item)
        self.update_btn.grid(row=2, column=2)

        self.exit_btn = tk.Button(
            self.master, text="Clear Input", width=20, command=self.clear_text)
